...
from .openai_compatible_provider import OpenAICompatibleVisionProvider, OpenAICompatibleTextProvider
...
def register_all_providers():
    ...
    LLMServiceManager.register_vision_provider('openai_compatible', OpenAICompatibleVisionProvider)
    ...
    LLMServiceManager.register_text_provider('openai_compatible', OpenAICompatibleTextProvider)
